...
if (!function_exists('ui_button_primary_classes')) {
    ...
    {
        return 'font-app inline-flex cursor-pointer select-none rounded-md border border-app-accent bg-app-accent px-4 py-2 text-sm font-medium text-app-text no-underline hover:bg-app-accentHover hover:no-underline';
    }
}
...
if (!function_exists('ui_button_small_classes')) {
    ...
    {
        return 'font-app inline-flex cursor-pointer select-none rounded-md border border-app-borderControl bg-app-panelSubtle px-[18px] py-2 text-sm font-medium text-app-muted no-underline hover:bg-app-accentSoft hover:text-app-accent hover:no-underline';
    }
}
...
if (!function_exists('ui_button_icon_classes')) {
    ...
    {
        return 'font-app inline-flex h-10 w-10 cursor-pointer select-none items-center justify-center rounded-md border border-app-borderControl bg-app-panelSubtle text-app-muted no-underline hover:bg-app-accentSoft hover:text-app-accent hover:no-underline';
    }
}
...
if (!function_exists('ui_button_small_primary_classes')) {
    ...
    {
        return 'font-app inline-flex cursor-pointer select-none rounded-md border border-app-accent bg-app-accent px-2.5 py-1.5 text-xs text-app-textOnBrand no-underline hover:bg-app-accentHover hover:no-underline';
    }
}

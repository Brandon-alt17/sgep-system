...
$positionClass = trim((string) ($positionClass ?? 'bottom-6 right-6'));
$toastClass = 'sg-toast';
if ($isError) {
...
?>
<section class="pointer-events-none fixed <?= e($positionClass) ?> z-[65] w-full max-w-sm px-4 sm:px-0" data-toast-root>

...
$subtle = 'text-sm font-semibold text-app-text';
...
<?php else: ?>
    ...
    <section class="bg-app-bg mb-4 flex flex-row items-start gap-2">
        ...
        <div class="mb-3 flex min-w-0 flex-1 flex-col gap-2 pl-4">
            <p class="m-0 text-sm text-app-muted">Elija qué bloques incluir y descargue el Word consolidado.</p>
    ...
    <form method="post" action="<?= e(APP_BASE_PATH) ?>/documentos/generar" class="flex w-full max-w-none flex-col gap-6">
        ...
        <input type="hidden" name="formato" value="docx">
        ...
        <section class="<?= $card ?> w-full !p-6 text-left">
            <p class="m-0 text-xs text-app-muted">Resumen tomado del perfil del aprendiz para esta exportación.</p>
            <h3 class="m-0 mt-2 text-left text-base font-semibold text-app-text">Datos del aprendiz</h3>
        ...
        <section class="<?= $card ?> w-full !p-6">
            <p class="m-0 text-left text-xs text-app-muted">Marque las plantillas que desea unir en un solo Word.</p>
            <h3 class="m-0 mt-2 text-left text-base font-semibold text-app-text">Seleccionar documentos a incluir</h3>
        ...
        <section class="<?= $card ?> w-full !p-6 text-left">
            <p class="m-0 text-sm text-app-muted">Solo <strong class="font-medium text-app-text">Microsoft Word (.docx)</strong>. La exportación a PDF estará disponible más adelante.</p>
            <h3 class="<?= e($subtle) ?> m-0 mt-2 text-left">Formato de exportación</h3>
        </section>

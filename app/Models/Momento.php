...
class Momento
{
    ...
    public static function create(array $data): int
    {
        ...
        $pdo->prepare($sql)->execute([
            ...
            'fecha_seguimiento_anterior' => self::nullableDate($data['fecha_seguimiento_anterior'] ?? null),
            'motivo_seguimiento_extraordinario' => $data['motivo_seguimiento_extraordinario'] ?? null,
    ...
    public static function update(int $id, array $data): void
    {
        $sql = 'UPDATE momentos
                SET
                    ...
                    fecha_seguimiento_anterior=:fecha_seguimiento_anterior,
                    motivo_seguimiento_extraordinario=:motivo_seguimiento_extraordinario,
